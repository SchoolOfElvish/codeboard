      ...
      <div class="shadow sm:overflow-hidden sm:rounded-md">
        ...
        <div class="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
          <div class="shadow sm:overflow-hidden sm:rounded-md">
            <div class="space-y-6 bg-white py-6 px-4 sm:p-6">
              <div>
                <h3 class="text-lg font-medium leading-6 text-gray-900">Input your birthday date</h3>
                <form>
                  <div class="date-picker">
                    <input class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" type="date"  id="party" name="party" min="1900-01-01" max="2099-01-01" required>
