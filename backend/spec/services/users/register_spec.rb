...
RSpec.describe Users::Register do
  ...
  let(:params) do
    { email: 'test@gmail.com', password: 'qwerty123', password_confirmation: 'qwerty123', first_name: 'testfirst',
      last_name: 'testlast', role: '1' }
  end
  ...
  context 'when params are invalid' do
    let(:params) do
      { email: '', password: '', password_confirmation: '', first_name: 'testfirst', last_name: 'testlast', role: '1' }
    end
